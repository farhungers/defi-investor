...
def main() -> int:
    ...
    lines = [
        ...
        "-" * 70,
        "CAVEAT (HYPOTHESIS_A2a red-team #8, added 2026-07-28):",
        "  Family-wise correction below uses N_registered=3 hypotheses.",
        "  Under proper DSR (Bailey & de Prado 2014, LIB_0002), effective N",
        "  is closer to 9 (3 hypotheses x 3 CV horizons). A marginal PASS",
        "  should be treated with skepticism and re-checked under DSR before",
        "  any downstream action. See docs/preregistrations/HYPOTHESIS_A2a.md.",
        "-" * 70,
        "Corpus",
